...
('Carla Mendes', '444.555.666-77', '1993-07-03', 'Av. Paulista 1853, São Paulo', '11987659876', 'carla.mendes@email.com', 'Atendente', 2700.00, '2020-07-15'),
...
VALUES  
(4, 1, 2, 1, 42.00, '2024-07-01', 'Concluído'),
(4, 2, 1, 1, 29.90, '2024-07-01', 'Concluído'),
(7, 3, 1, 1, 29.90, '2024-07-01', 'Concluído'),
(7, 4, 3, 3, 37.50, '2024-07-01', 'Concluído'),
(8, 5, 2, 2, 42.00, '2024-07-02', 'Pendente'),
(8, 6, 4, 4, 45.00, '2024-07-02', 'Concluído'),
(4, 7, 3, 3, 37.50, '2024-07-02', 'Concluído'),
(4, 8, 2, 2, 42.00, '2024-07-02', 'Concluído'),
(7, 9, 5, 5, 38.00, '2024-07-02', 'Concluído'),
(7, 10, 1, 1, 29.90, '2024-07-03', 'Concluído'),
(8, 11, 3, 3, 37.50, '2024-07-03', 'Concluído'),
(8, 12, 1, 1, 29.90, '2024-07-03', 'Concluído'),
(4, 13, 2, 2, 42.00, '2024-07-03', 'Concluído'),
(4, 14, 1, 1, 29.90, '2024-07-03', 'Concluído'),
(7, 15, 2, 2, 42.00, '2024-07-03', 'Concluído'),
(7, 16, 3, 3, 37.50, '2024-07-04', 'Concluído'),
(8, 17, 2, 2, 42.00, '2024-07-04', 'Concluído'),
(8, 18, 4, 4, 45.00, '2024-07-04', 'Concluído'),
(4, 19, 1, 1, 29.90, '2024-07-04', 'Concluído'),
(4, 20, 2, 2, 42.00, '2024-07-04', 'Concluído'),
(7, 2, 1, 1, 29.90, '2024-07-04', 'Concluído'),
(7, 3, 2, 2, 42.00, '2024-07-05', 'Concluído'),
(8, 4, 3, 3, 37.50, '2024-07-05', 'Concluído'),
(8, 5, 1, 1, 29.90, '2024-07-05', 'Concluído'),
(4, 6, 4, 4, 45.00, '2024-07-05', 'Concluído'),
(4, 7, 3, 3, 37.50, '2024-07-05', 'Concluído'),
(7, 8, 2, 2, 42.00, '2024-07-05', 'Concluído'),
(7, 9, 5, 5, 38.00, '2024-07-05', 'Concluído'),
(8, 10, 1, 1, 29.90, '2024-07-05', 'Concluído'),
(8, 11, 3, 3, 37.50, '2024-07-05', 'Concluído'),
(4, 12, 1, 1, 29.90, '2024-07-05', 'Concluído'),
(4, 13, 2, 2, 42.00, '2024-07-05', 'Concluído'),
(7, 14, 1, 1, 29.90, '2024-07-05', 'Concluído'),
(7, 15, 2, 2, 42.00, '2024-07-06', 'Concluído'),
(8, 16, 3, 3, 37.50, '2024-07-06', 'Concluído'),
(8, 17, 2, 2, 42.00, '2024-07-06', 'Pendente'),
(4, 18, 4, 4, 45.00, '2024-07-06', 'Concluído'),
(4, 19, 1, 1, 29.90, '2024-07-06', 'Pendente'),
(7, 20, 2, 2, 42.00, '2024-07-06', 'Concluído'),
(7, 1, 2, 2, 42.00, '2024-07-06', 'Pendente'),
(8, 2, 1, 1, 29.90, '2024-07-06', 'Concluído'),
(8, 3, 2, 2, 42.00, '2024-07-06', 'Pendente'),
(4, 4, 3, 3, 37.50, '2024-07-06', 'Concluído'),
(4, 5, 1, 1, 29.90, '2024-07-06', 'Pendente'),
(7, 6, 4, 4, 45.00, '2024-07-06', 'Concluído'),
(7, 7, 3, 3, 37.50, '2024-07-06', 'Pendente'),
(8, 8, 2, 2, 42.00, '2024-07-06', 'Concluído'),
(8, 8, 2, 2, 42.00, '2024-07-06', 'Concluído'),
(4, 10, 1, 1, 29.90, '2024-07-06', 'Concluído'),
(4, 11, 3, 3, 37.50, '2024-07-06', 'Pendente');


-- Tabela de Informações Adicionais dos Produtos
...
SET @count = 0;
UPDATE clientes SET id_cliente = @count := @count + 1;
...
-- exlusao de funcionario
SELECT * FROM funcionarios WHERE cpf = '222.333.444-55';
UPDATE pedidos SET id_funcionario = NULL WHERE id_funcionario = (SELECT id_funcionario FROM funcionarios WHERE cpf = '222.333.444-55' LIMIT 1);
DELETE FROM pedidos WHERE id_funcionario = (SELECT id_funcionario FROM funcionarios WHERE cpf = '222.333.444-55' LIMIT 1);
...
-- selecao de nome, telefone, nascimento 
SELECT nome, telefone, data_nascimento 
   FROM clientes 
   WHERE YEAR(data_nascimento) < 1985;
   
   -- selecao de produto e ingredientes 
...
WHERE ip.ingredientes LIKE '%carne%';
  ...
  -- produto selecao prato principal
  SELECT * 
   FROM produtos 
   ...
   -- Seleção todos os pedidos do id funcionário igual a 4 e status igual a Pendente
   SELECT * FROM pedidos WHERE id_funcionario = 5 AND status = 'Pendente';

-- Seleção todos os pedidos que o status não é igual a ‘Concluído’:
SELECT * FROM pedidos WHERE status <> 'Concluído';

-- Selecionar os pedidos que contenham os id produtos: 1, 3, 5, 7 ou 8
SELECT * FROM pedidos WHERE id_produto IN (1, 3, 5, 7, 8);

-- Selecionar os clientes que começam com a letra 'C':
SELECT * FROM clientes WHERE nome LIKE 'C%';

-- Selecionar as informações de produtos que contenham nos ingredientes ‘carne’ ou ‘frango’:
SELECT * FROM info_produtos WHERE ingredientes LIKE '%carne%' OR ingredientes LIKE '%frango%';

-- Selecionar os produtos com o preço entre 20 e 30:
SELECT * FROM produtos WHERE preco BETWEEN 20 AND 30;

-- Atualizar o id pedido 6 da tabela pedidos para status = NULL:
UPDATE pedidos SET status = NULL WHERE id_pedido = 6;

-- Selecionar os pedidos com status nulos
SELECT * FROM pedidos WHERE status IS NULL;

-- Selecionar o id pedido e o status da tabela pedidos, mostrando 'Cancelado' para todos os status nulos:
 SELECT id_pedido, 
          CASE WHEN status IS NULL THEN 'Cancelado' ELSE status END AS status 
   FROM pedidos;
   
   -- Selecionar o nome, cargo, salário dos funcionários e adicionar um campo chamado media_salario:
   SELECT nome, cargo, salario,
           CASE WHEN salario > 3000 THEN 'Acima da média' ELSE 'Abaixo da média' END AS media_salario 
    FROM funcionarios;
